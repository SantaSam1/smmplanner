...
const OAUTH_URLS: Record<string, { authUrl: string; scopes: string[]; sep: string }> = {
  ...
  instagram: { authUrl: 'https://www.facebook.com/v19.0/dialog/oauth', scopes: ['email','public_profile','business_management','pages_show_list','pages_read_engagement','instagram_basic','instagram_content_publish'], sep: ',' },
